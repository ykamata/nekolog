...
export const VeterinaryHospitalUpdateSchema = VeterinaryHospitalInputSchema.partial();
export const VeterinaryDoctorUpdateSchema = VeterinaryDoctorInputSchema.partial();
export const VeterinaryTreatmentUpdateSchema = VeterinaryTreatmentInputSchema.partial();
export const VeterinaryVisitUpdateSchema = VeterinaryVisitInputSchema.partial();
export const VeterinaryAppointmentUpdateSchema = VeterinaryAppointmentInputSchema.partial().extend({
...
export type VeterinaryHospitalInput = z.infer<typeof VeterinaryHospitalInputSchema>;
export type VeterinaryDoctorInput = z.infer<typeof VeterinaryDoctorInputSchema>;
export type VeterinaryTreatmentInput = z.infer<typeof VeterinaryTreatmentInputSchema>;
export type VeterinaryVisitInput = z.infer<typeof VeterinaryVisitInputSchema>;
export type VeterinaryAppointmentInput = z.infer<typeof VeterinaryAppointmentInputSchema>;
...
export type VeterinaryTreatmentUpdate = z.infer<typeof VeterinaryTreatmentUpdateSchema>;
export type VeterinaryVisitUpdate = z.infer<typeof VeterinaryVisitUpdateSchema>;
export type VeterinaryAppointmentUpdate = z.infer<typeof VeterinaryAppointmentUpdateSchema>;

export type ConvertAppointmentToVisit = z.infer<typeof ConvertAppointmentToVisitSchema>;

export type VeterinaryVisitFilter = z.infer<typeof VeterinaryVisitFilterSchema>;
export type VeterinaryAppointmentFilter = z.infer<typeof VeterinaryAppointmentFilterSchema>;
export type VeterinaryHospitalFilter = z.infer<typeof VeterinaryHospitalFilterSchema>;
export type VeterinaryDoctorFilter = z.infer<typeof VeterinaryDoctorFilterSchema>;
export type VeterinaryTreatmentFilter = z.infer<typeof VeterinaryTreatmentFilterSchema>;

export type VeterinaryVisitForm = z.infer<typeof VeterinaryVisitFormSchema>;
export type VeterinaryAppointmentForm = z.infer<typeof VeterinaryAppointmentFormSchema>;
