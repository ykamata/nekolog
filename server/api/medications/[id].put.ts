...
import { withErrorContext, validateParams, validateBody } from '~/server/utils/error-handler';

const paramsSchema = z.object({
  id: z.string().cuid('Invalid medication ID format'),
});

export default defineEventHandler(withErrorContext('/api/medications/[id] [PUT]')(async (event) => {
